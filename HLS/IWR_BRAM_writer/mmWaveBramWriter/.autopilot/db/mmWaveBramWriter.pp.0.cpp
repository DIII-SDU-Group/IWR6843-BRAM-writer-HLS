...
# 3 "mmWaveBramWriter.cpp" 2




void loadBuffer(ap_uint<128> buffer_in[32], ap_uint<128> buffer[32]);

void writeBuffer(ap_uint<128> buffer[32], uint32_t buffer_out[32*4]);

__attribute__((sdx_kernel("mmWBramWriter", 0))) void mmWBramWriter(ap_uint<128> buffer_in[32], uint32_t buffer_out[32*4]) {_ssdm_SpecArrayDimSize(buffer_in, 32);_ssdm_SpecArrayDimSize(buffer_out, 128);
...
void writeBuffer(ap_uint<128> buffer[32], uint32_t buffer_out[32*4]) {
  ...
  write_loop: for (int i = 0; i < 32*4; i++) {
