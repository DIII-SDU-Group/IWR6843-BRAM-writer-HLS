...
set C_modelName {mmWBramWriter}
set C_modelType { void 0 }
set C_modelArgList {
	{ buffer_in int 128 regular {array 32 { 1 3 } 1 1 }  }
	{ buffer_out int 32 regular {array 128 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ buffer_out_address0 sc_out sc_lv 7 signal 1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"mmWBramWriter","role":"start","value":"0","valid_bit":"0"},{"name":"mmWBramWriter","role":"continue","value":"0","valid_bit":"4"},{"name":"mmWBramWriter","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"mmWBramWriter","role":"start","value":"0","valid_bit":"0"},{"name":"mmWBramWriter","role":"done","value":"0","valid_bit":"1"},{"name":"mmWBramWriter","role":"idle","value":"0","valid_bit":"2"},{"name":"mmWBramWriter","role":"ready","value":"0","valid_bit":"3"},{"name":"mmWBramWriter","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "buffer_out_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "buffer_out", "role": "address0" }} , 
...
set ArgLastReadFirstWriteLatency {
	mmWBramWriter {
		...
		buffer_out {Type O LastRead -1 FirstWrite 4}}}
...
set Spec2ImplPortList { 
	...
	buffer_out { ap_memory {  { buffer_out_address0 mem_address 1 7 }  { buffer_out_ce0 mem_ce 1 1 }  { buffer_out_we0 mem_we 1 1 }  { buffer_out_d0 mem_din 1 32 } } }
}
