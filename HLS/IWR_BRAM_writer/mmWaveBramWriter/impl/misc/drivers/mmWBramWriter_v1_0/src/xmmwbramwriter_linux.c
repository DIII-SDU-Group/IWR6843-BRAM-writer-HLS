...
typedef struct {
    ...
    XMmwbramwriter_uio_map maps[ MAX_UIO_MAPS ];
} XMmwbramwriter_uio_info;

/***************** Variable Definitions **************************************/
static XMmwbramwriter_uio_info uio_info;
...
int XMmwbramwriter_Initialize(XMmwbramwriter *InstancePtr, const char* InstanceName) {
	XMmwbramwriter_uio_info *InfoPtr = &uio_info;
