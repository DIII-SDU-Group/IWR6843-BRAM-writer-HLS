...
architecture rtl of mmWBramWriter_buffer_r_rom is 
...
architecture arch of mmWBramWriter_buffer_r is
    component mmWBramWriter_buffer_r_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mmWBramWriter_buffer_r_rom_U :  component mmWBramWriter_buffer_r_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
